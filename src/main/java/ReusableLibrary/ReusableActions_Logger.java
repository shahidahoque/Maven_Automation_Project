...
public class ReusableActions_Logger {
    ...
    public static void clickActionByIndex(WebDriver driver, String xpath, int index, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            System.out.println("Unable to click on element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to click by index " + elementName + "for reason: " + e);
        }
    }
    ...
    public static void mouseHover(WebDriver driver, String xpath, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.PASS, "Successfully moved to element " + elementName);
        } catch (Exception e) {
            System.out.println("Unable to hover to element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to move  to element " + elementName + "for reason: " + e);
        }
    }
    ...
    public static void sendKeysAction(WebDriver driver, String xpath, String userInput, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            logger.log(LogStatus.PASS, "Successfully clicked sent keys for " + elementName);
        } catch (Exception e) {
    ...
    public static String getTextActionByIndex(WebDriver driver, String xpath, int index, ExtentTest logger, String elementName) {
        String textOutput = "";
        try {
            ArrayList <WebElement> element = new ArrayList<>(driver.findElements(By.xpath(xpath)));
    ...
    public static String scrollByView(WebDriver driver, String xpath, ExtentTest logger, String elementName) {
        ...
        try {
            ...
            System.out.println("Unable to scroll by element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to scroll to element: " + elementName + " for reason: " + e);
        }
        return xpath;
    }//end of submit action
    ...
    public static void selectByText(WebDriver driver, String xpath, String text, ExtentTest logger, String elementName){
        ...
        try {
            ...
            logger.log(LogStatus.PASS, "Successfully selected drop down element " + elementName);
        } catch (Exception e) {
            System.out.println("Unable to select drop down element: " + elementName + " for reason: " + e);
            logger.log(LogStatus.FAIL, "Unable to scroll to element: " + elementName + " for reason: " + e);
        }
